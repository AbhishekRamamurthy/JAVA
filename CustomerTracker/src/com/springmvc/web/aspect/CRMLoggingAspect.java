package com.springmvc.web.aspect;
...
public class CRMLoggingAspect {
	...
	@Pointcut("execution(* com.springmvc.web.controller.*.*(..))")
	private void forControllerPackage() {}

	@Pointcut("execution(* com.springmvc.web.service.*.*(..))")
	private void forServicePackage() {}
	
	@Pointcut("execution(* com.springmvc.web.dai.*.*(..))")
